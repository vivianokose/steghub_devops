...
📸 **Screenshot Placeholder:** Architecture diagram image (optional)
...
📸 **Screenshot Placeholder:** Repository structure from terminal
...
📸 **Screenshot Placeholder:** env-vars directory
`![env-vars Folder](images/step3-env-vars.png)`
...
`![env-vars.yml](images/step4-env-vars-yml.png)`
...
📸 **Screenshot Placeholder:** Updated site.yml
`![site.yml Updated](images/step5-site-yml.png)`
...
📸 **Screenshot Placeholder:** MySQL role installed output
`![MySQL Role Install](images/step6-mysql-role-install.png)`
...
📸 **Screenshot Placeholder:** MySQL variables
`![MySQL Vars](images/step8-mysql-vars.png)`
...
![](images/step9-db-servers-yml.png)
...
📸 Screenshot Placeholder:
![](images/step10-push-mysql-role.png)
...
📸 Screenshot Placeholder:
![](images/step11-nginx-apache-install.png)

📸 **Screenshot Placeholder:** Roles created
`![Load Balancer Roles](images/step9-lb-roles.png)`
...
📸 Screenshot Placeholder:
![](images/step12-default-vars.png)

📸 **Screenshot Placeholder:** nginx defaults
`![Nginx Defaults](images/step10-nginx-defaults.png)`

📸 **Screenshot Placeholder:** apache defaults
`![Apache Defaults](images/step10-apache-defaults.png)`
...
📸 Screenshot Placeholder:
![](images/step13-loadbalancers-yml.png)

📸 **Screenshot Placeholder:** loadbalancers.yml
`![Loadbalancers Config](images/step11-loadbalancers.png)`
...
📸 Screenshot Placeholder:
![](images/step14-uat-nginx-enable.png)

📸 **Screenshot Placeholder:** UAT LB variables
`![Enable Nginx LB](images/step12-enable-nginx.png)`
...
📸 Screenshot Placeholder:
![](images/step15-webserver-role.png)
...
📸 Screenshot Placeholder:
![](images/step16-inventory-uat.png)
...
📸 Screenshot Placeholder:
![](images/step17-playbook-run.png)

📸 **Screenshot Placeholder:** Playbook execution output
`![Playbook Run](images/step13-playbook-run.png)`
...
📸 Screenshot Placeholder:
![](images/validation-httpd.png)

📸 **Screenshot Placeholder:** Webserver status
`![Webserver Status](images/validation-httpd.png)`
...
📸 Screenshot Placeholder:
![](images/validation-tooling-website.png)

📸 **Screenshot Placeholder:** Tooling website loaded
`![Tooling Website](images/validation-tooling-website.png)`
